...
describe('Trusted Source Autopilot', () => {
  ...
  it('shows live imported intelligence counts from durable dashboard state', () => {
    ...
    expect(text).toContain('0/10 targets covered')
    expect(text).toContain('Missing targets: China, Bangladesh, India')
    ...
    expect(text).toContain('Evonik Industries - Confidence')
    expect(text).toContain('Stepan Company - Source metadata')
    expect(text).toContain('Stepan Company - Next action')
  ...
  it('starts a focused Hermes job for missing trusted-source coverage targets', async () => {
    ...
    expect(prompt).toContain('Evonik Industries - Confidence')
    expect(prompt).toContain('Stepan Company - Source metadata')
    expect(prompt).toContain('Stepan Company - Next action')
