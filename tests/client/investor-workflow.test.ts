...
describe('investor readiness pages', () => {
  ...
  it('shows real feasibility intelligence triage on Home without fake business metrics', async () => {
    ...
    expect(wrapper.text()).toContain('Executive business snapshot')
    expect(wrapper.text()).toContain('Revenue')
    expect(wrapper.text()).toContain('Growth Rate')
    expect(wrapper.text()).toContain('Market Position')
    expect(wrapper.text()).toContain('Key Opportunities')
    ...
    expect(wrapper.text()).toContain('Market share comparison')
    expect(wrapper.text()).toContain('Growth trend')
    expect(wrapper.text()).toContain('Opportunity score')
    expect(wrapper.text()).toContain('Risk heat map')
    ...
    expect(wrapper.text()).toContain('Review-gated items are waiting')
    ...
    expect(wrapper.find('.home-autopilot-details').exists()).toBe(true)
    expect(wrapper.find('.home-autopilot-details').attributes('open')).toBeUndefined()
    expect(wrapper.find('.home-autopilot-details summary').text()).toContain('How automatic filling works')
    expect(wrapper.find('.home-autopilot-details summary').text()).toContain('Optional details')
    expect(wrapper.text()).toContain('Research online')
    expect(wrapper.text()).toContain('Review risky claims')
    expect(wrapper.text()).toContain('Fill safe fields')
    expect(wrapper.text()).toContain('Use the dashboard')
    expect(wrapper.text()).toContain('No manual web searching')
    expect(wrapper.text()).toContain('Source-backed records fill approved fields')
    ...
    expect(wrapper.text()).toContain('Not supplier quote, landed cost, or procurement truth.')
    expect(wrapper.findAll('.source-connector-grid article')).toHaveLength(5)
    expect(wrapper.text()).toContain('Where Hermes fills the dashboard')
    expect(wrapper.text()).toContain('Safe source-backed records can appear automatically')
    ...
    expect(wrapper.text()).toContain('Review staged items and approve only the evidence-backed values you trust.')
    expect(wrapper.text()).toContain('Start Here')
    expect(wrapper.text()).toContain('Daily owner actions only')
    expect(wrapper.text()).toContain('Evidence, readiness, and capture details')
    expect(wrapper.find('.home-evidence-details').exists()).toBe(true)
    expect(wrapper.find('.home-evidence-details').attributes('open')).toBeUndefined()
    expect(wrapper.find('.home-evidence-details summary').text()).toContain('Open for evidence gaps')
    expect(wrapper.text()).toContain('All workspaces, readiness snapshot, and system details')
    expect(wrapper.find('.home-focus-panel').exists()).toBe(true)
    expect(wrapper.find('.home-advanced-section').exists()).toBe(true)
    expect(wrapper.find('.home-advanced-section').attributes('open')).toBeUndefined()
    expect(wrapper.text()).toContain('Factory evidence')
    ...
    const financialSnapshotCard = wrapper.findAll('.investor-snapshot-grid .kpi-card')
      .find(card => card.text().includes('Financial Model'))
    expect(financialSnapshotCard).toBeTruthy()
    expect(financialSnapshotCard!.text()).toContain('No approved financial snapshot')
    expect(financialSnapshotCard!.text()).toContain('Review-gated financial model')
    expect(financialSnapshotCard!.text()).not.toContain('Base')
    expect(financialSnapshotCard!.text()).not.toContain('Derived from Assumptions')
    expect(wrapper.text()).toContain('Approve a sourced or user-approved scenario before discussing investor returns.')
