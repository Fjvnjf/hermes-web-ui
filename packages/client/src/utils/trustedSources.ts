...
const SOURCE_SEEDS: SourceSeed[] = [
  ...
  seed('sec-companyfacts', 'SEC EDGAR Company Facts', 'https://data.sec.gov/api/xbrl/companyfacts/', 'tier1-official', 'competitor', ['company_data', 'financial_data'], 'API', ['competitor', 'investorReadiness', 'presentation'], 'Official public company filing facts. Use for competitor/company context only; never as market share, product pricing, or private supplier proof.'),
