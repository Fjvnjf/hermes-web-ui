...
export const ROUTE_ACCESS_POLICIES: RouteAccessPolicy[] = [
  ...
  { routeName: 'hermes.regulatory', sensitivity: 'confidential', allowedRoles: ['owner', 'research_assistant', 'regulatory_consultant'], note: 'Regulatory findings include DMS/CAS/safety claims and remain review-gated.' },
  ...
  { routeName: 'hermes.trustedSources', sensitivity: 'system-admin-only', allowedRoles: ['owner'], note: 'Trusted source registry controls autonomous dashboard updates and is owner-only.' },
