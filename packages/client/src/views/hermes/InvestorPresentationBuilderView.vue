...
function createSlideResearchJob(slide: InvestorSlideDraft) {
  ...
  try {
    ...
    intelligence.addResearchJob({
      ...
      sourceRequirements: 'Every claim needs a source title plus URL/date, or it stays in Hermes verification. Investor text must be clearly labeled Verified, User Approved, or Approved Assumption.',
      priority,
...
function createMaterialResearchJob(material: PresentationMaterial) {
  ...
  try {
    ...
    intelligence.addResearchJob({
      ...
      sourceRequirements: 'Do not promote unsupported claims. Verified material requires source title plus URL/date. Unknown market share, market size, pricing, and investor return claims stay in Hermes verification unless sourced.',
      priority,
      schedulePreference: 'Tonight',
      context: 'Chemicon China Feasibility',
      status: 'Manual Research Job',
