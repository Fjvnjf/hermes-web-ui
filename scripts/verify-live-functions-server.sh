...
auth_json "hermes-history" "/api/hermes/sessions/hermes?limit=1"
auth_json "config" "/api/hermes/config"
auth_json "models" "/api/hermes/config/models"
auth_json "available-models" "/api/hermes/available-models"
auth_json "jobs" "/api/hermes/jobs"
auth_json "kanban-stats" "/api/hermes/kanban/stats"
auth_json "logs" "/api/hermes/logs"
auth_json "usage" "/api/hermes/usage/stats"
auth_json "performance" "/api/hermes/performance/runtime"
auth_json "skills" "/api/hermes/skills"
auth_json "skills-usage" "/api/hermes/skills/usage/stats"
auth_json "plugins" "/api/hermes/plugins"
auth_json "memory" "/api/hermes/memory"
auth_json "files" "/api/hermes/files/list?path="
